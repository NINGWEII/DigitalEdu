...
public class DigitalEdu_HomeWork_5 {
...
// 		     Find index of an element. If element not found print out -1
	...
	private static void secondProblem() {
		...
		printSecondProblemResult(arr, indexOfNum, num2);
		printSecondProblemResult(arr, indexOfNum, num3);
		printSecondProblemResult(arr, indexOfNum, num4);
	}
